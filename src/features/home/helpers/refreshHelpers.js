...
import { isSameDay } from '../../../shared/datetime.js';
...
export function refreshUI() {
  ...
  // After toggling classes, center selected day using new API
  if (HomeCalendar.ready && HomeCalendar.scrollToSelected) {
    HomeCalendar.ready.then(() => {
      // Small delay to ensure DOM updates are complete
      setTimeout(() => {
        HomeCalendar.scrollToSelected();
      }, 10);
    });
  }
